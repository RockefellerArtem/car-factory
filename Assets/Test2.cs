...
public class Test2 : MonoBehaviour
{
    ...
    //private List<Gasoline> _gasolines = new List<Gasoline>();
    //private List<Doors> _doors = new List<Doors>();
    //private List<Powers> _powers = new List<Powers>();
    ...
    //private void CreateCar(Car car,Gasoline gasoline,Doors doors, Powers powers, bool isAddCars = false)
    //{
        
    //    var carHolder = Instantiate(_carHolderPrefab, _context);
    //    carHolder.Init(car, gasoline,doors, powers,_currentTexture);
    ...
    public class Tester
    {
        ...
        public Tester(string name, int age) : this(name) // здесь идёт передача аргумента из текущего констурктора 
        {
            Age = age;
        }
    }

    public class TesterChildren : Tester
    {
        public string Type { get; set; }

        public TesterChildren()
        {
